...
namespace Ex03.GarageLogic
{
    public class Garage
    {
        ...
        public static Vehicle ProduceMotorcycle(eEnergySourceType i_EnergySourceType, float i_CurrentEnergy, string i_ModelName, string i_LicenseName, eLicenseType i_LicenseType, int i_EngineCapacity)
        {
            Motorcycle newMotorcycle = new Motorcycle(i_ModelName, i_LicenseName, i_EngineCapacity, i_LicenseType);
        ...
        //    vehicle.InflateWheelsToMaximum();
        //}
